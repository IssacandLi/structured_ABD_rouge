...
LOG_ROOT=${LOG_ROOT:-$PWD/sample_logs/ndp_pilot/wp}

BASELINE_CKPT=${BASELINE_CKPT:-/data/lab/yan/peihong_li/ACL/block_diff_cond/outputs/ndp_pilot/wp/baseline_bs${BLOCK_SIZE}/checkpoints/best.ckpt}
STRUCTURED_CKPT=${STRUCTURED_CKPT:-$PWD/outputs/ndp_pilot/wp/structured_bs${BLOCK_SIZE}/checkpoints/best.ckpt}
